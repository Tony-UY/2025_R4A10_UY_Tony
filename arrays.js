...
module.exports = {
    ...
    Q4() {
        let monTableau4 = getArray();
        monTableau4.sort((a, b) => a - b);
        return monTableau4;
    },

    //5) Ajouter la valeur 0 en premier index du tableau, renvoyez le tableau modifié
    Q5() {
        let monTableau5 = getArray();
        monTableau5.unshift(0);
        return monTableau5;
    },
    ...
    Q7() {
        return getArray().reduce((element1, element2) => element1 + element2, 0);
    },

    //8) Remplacer la troisième valeur du tableau par "ici", renvoyez le tableau
    Q8() {
        const monTableau8 = getArray();
        monTableau8[2] = "ici";
        return monTableau8;
    },
    ...
    Q13() {
        return getArray().slice(getArray().length-2,getArray().length)
    }
};
